...
class XTSCommon:
    ...
    def __init__(self, token=None, userID=None, isInvestorClient=False):
        """Initialize the common variables."""
        self.token = token
        self.userID = userID
        self.isInvestorClient = False


class UpdatedXTSConnect(XTSCommon):
    """
    ...
    def interactive_login(self, token, userId):
        """Send the login url to which a user should receive the token."""
        try:
            self._set_common_variables(token, userId, isInvestorClient=False)
        except Exception as e:
            print(f"Error in interactive Login: {e}")
    ...
    def get_holding(self, clientID=None):
        ...
        try:
            ...
            print("Error in Getting Holding: ", e)
    ...
    def marketdata_login(self, token, userId):
        try:

            self._set_common_variables(token, userId, True)
        except Exception as e:
            ...
    ...
    def get_ohlc(
        ...
        try:
            ...
            print(f"Error in Getting OHLC: {e}")
            return response["description"]
